...
function renderSwitcher() {
  ...
  mount.innerHTML = `
    <button onclick="event.stopPropagation(); window.playerUI.toggleDropdown()" style="background:#f5f5f5; border:none; border-radius:20px; padding:6px 10px; display:flex; align-items:center; gap:6px; font-size:12px; font-weight:600; cursor:pointer; font-family:inherit;">
      ...
      <span style="max-width:60px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">${current.name}</span>
