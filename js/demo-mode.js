...
function withGender(list, gender, mixedIndexes = []) {
  const other = gender === '男子' ? '女子' : '男子';
  return list.map((m, i) => ({ ...m, gender: mixedIndexes.includes(i) ? other : gender }));
}
...
function buildDemoOpponents() {
  return [
    { id: 'demo-o-1', name: '佐藤 健',  team: '青葉中学校',    age: 14, pref: '東京', hand: '右利き', type: 'シェークハンド裏裏', gender: '男子' },
    { id: 'demo-o-2', name: '田中 蓮',  team: '川島卓球クラブ', age: 15, pref: '東京', hand: '右利き', type: 'カットマン（粒高）', gender: '男子' },
    { id: 'demo-o-3', name: '伊藤 颯',  team: '北央中学校',    age: 15, pref: '埼玉', hand: '右利き', type: 'カットマン（粒高）', gender: '男子' },
    { id: 'demo-o-4', name: '中村 芽依', team: '桜台ジュニア',  age: 12, pref: '東京', hand: '右利き', type: 'シェークハンド裏裏', gender: '女子' },
  ];
}
