...
function renderAuthForm() {
  ...
  container.innerHTML = `
    <div style="display:flex; flex-direction:column; gap:12px;">
      ...
      <button onclick="window.demoMode && window.demoMode.enter()" style="padding:12px; background:none; border:1.5px dashed #ccc; border-radius:12px; color:#666; font-size:14px; font-weight:600; cursor:pointer; font-family:inherit;">
        登録せずに試してみる（デモ）
      </button>
